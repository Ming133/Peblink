...
const environmentAdvancedMapData: Record<Exclude<EnvironmentLayer, OverviewLayer>, OverviewMapFeature[]> = {
  ...
  rainfall: [
    { id: "rain-boke", name: "Boké 72-hour Runoff Hotspot", type: "Rainfall and runoff risk", detail: "Illustrative heavy rainfall increases drainage connectivity toward Rio Nunez", coordinates: "10.91° N, 14.02° W", x: 29, y: 31, width: 25, height: 23, symbol: "☂", status: "86 mm / 72 h", risk: "Critical", confidence: "Moderate", timestamp: "Forecast window · 11–14 Aug 2026", periods: ["current", "30d", "12m"] },
    { id: "rain-kankan", name: "Kankan Storm-runoff Cell", type: "Rainfall and runoff risk", detail: "Illustrative storm cell raises short-term tailings-water review priority", coordinates: "10.07° N, 9.33° W", x: 70, y: 53, width: 23, height: 22, symbol: "☂", status: "54 mm / 72 h", risk: "High", confidence: "Moderate", timestamp: "Forecast window · 11–14 Aug 2026", periods: ["current", "30d", "12m"] },
    { id: "rain-nzerekore", name: "Nzérékoré Saturated-ground Zone", type: "Rainfall and runoff risk", detail: "Illustrative saturated ground increases sediment mobilisation potential", coordinates: "8.89° N, 9.01° W", x: 61, y: 76, width: 24, height: 22, symbol: "☂", status: "Wet-season anomaly", risk: "High", confidence: "Low", timestamp: "Observed · 3 Aug 2026", periods: ["30d", "12m"] },
  ],
};
